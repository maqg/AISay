package com.octlink.henry.aisay;
...
public class MainActivity extends AppCompatActivity implements EventListener {
    ...
    private void start() {
        ...
        params.put(SpeechConstant.APP_KEY, AIConfig.APIKey);
        params.put(SpeechConstant.SECRET, AIConfig.SecretKey);
        params.put(SpeechConstant.APP_NAME, AIConfig.AppName);
        params.put(SpeechConstant.APP_ID, AIConfig.APIId);
